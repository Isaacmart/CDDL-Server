...
export default class Display extends React.Component {
   ...
   componentDidUpdate(prevProps, prevState) {
      if (prevProps.file !== this.props.file){
         ...
         const src  = getRSC(pdb, detail, ilig);
 ...
 function getInfo(script) {
   ...
   var Info = {
      ...
      serverURL: "http://34.200.71.31/jmol-14.32.63/jsmol/php/jsmol.php"
   };

   return Info;
 }

 function getDSC(pdb, result, ilig) {

   return "background black; load " + pdb + 
 ...
 function getRSC(pdb, detail, ilig) {
   return "background black; load " + pdb + 

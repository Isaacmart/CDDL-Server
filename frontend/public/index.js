...
(function () {
	...
	*/
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$2(global$h, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	    global$h[key] = value;
	  } return value;
	};
	...
	var uncurryThis$d = NATIVE_BIND$3 && bind$5.bind(call$c, call$c);
	...
	*/
	  ...
	  _createClass(Display, [{
	    ...
	    value: function componentDidUpdate(prevProps, prevState) {
	      if (prevProps.file !== this.props.file) {
	        ...
	        var rsc = "background black; load " + pdb + "; cartoon only; color structure; load APPEND " + detail + "; load APPEND " + ilig + "; frame *; display 1.1,2.1,3.1" + "; select 2.1; spacefill only; spacefill 100; color relativeTemperature" + "; select 3.1; cpk only; cpk 150" + "; set spinY 5; spin";
	        ...
	        var dsc = "background black; load " + pdb + "; cartoon only; color structure; load APPEND " + result + "; load APPEND " + ilig + "; frame *; display 1.1,2.1,3.1" + "; select 2.1; cpk only; color " + scheme + "; color {2.1} property atomno \"myScheme\" range 1 10" + "; select 3.1; cpk only; cpk 150" + "; set spinY 5; spin";
	...
	var Input = /*#__PURE__*/function (_React$Component) {
	  ...
	  function Input(props) {
	    ...
	    _defineProperty(_assertThisInitialized(_this), "fetchFile", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
	...
	var App = /*#__PURE__*/function (_React$Component) {
	  ...
	  _createClass(App, [{
	    key: "render",
	    value: function render() {
	      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, "UGA CDDL LISE")), /*#__PURE__*/React.createElement(Input, null));
	    }
	  }]);
